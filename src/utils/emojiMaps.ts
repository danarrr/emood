...
export const emoji1Config = {
  'emoji1a': { key: 'emoji1a', src: domin + '/emoji1/a.png?' + sign, text: '' },
  'emoji1b': { key: 'emoji1b', src: domin + '/emoji1/b.png?' + sign, text: '' },
  'emoji1c': { key: 'emoji1c', src: domin + '/emoji1/c.png?' + sign, text: '' },
  'emoji1d': { key: 'emoji1d', src: domin + '/emoji1/d.png?' + sign, text: '' },
  'emoji1e': { key: 'emoji1e', src: domin + '/emoji1/e.png?' + sign, text: '' },
  'emoji1f': { key: 'emoji1f', src: domin + '/emoji1/f.png?' + sign, text: '' },
  'emoji1g': { key: 'emoji1g', src: domin + '/emoji1/g.png?' + sign, text: '' },
  'emoji1h': { key: 'emoji1h', src: domin + '/emoji1/h.png?' + sign, text: '' },
  'emoji1i': { key: 'emoji1i', src: domin + '/emoji1/i.png?' + sign, text: '' },
};
...
export const emoji5Config = {
  'emoji5a': { key: 'emoji5a', src: domin + '/emoji5/a.png?' + sign, text: '' },
  'emoji5b': { key: 'emoji5b', src: domin + '/emoji5/b.png?' + sign, text: '' },
  'emoji5c': { key: 'emoji5c', src: domin + '/emoji5/c.png?' + sign, text: '' },
  'emoji5d': { key: 'emoji5d', src: domin + '/emoji5/d.png?' + sign, text: '' },
  'emoji5e': { key: 'emoji5e', src: domin + '/emoji5/e.png?' + sign, text: '' },
  'emoji5f': { key: 'emoji5f', src: domin + '/emoji5/f.png?' + sign, text: '' },
  'emoji5g': { key: 'emoji5g', src: domin + '/emoji5/g.png?' + sign, text: '' },
  'emoji5h': { key: 'emoji5h', src: domin + '/emoji5/h.png?' + sign, text: '' },
  'emoji5i': { key: 'emoji5i', src: domin + '/emoji5/i.png?' + sign, text: '' },
};

export const emoji6Config = {
  'emoji6a': { key: 'emoji6a', src: domin + '/emoji6/a.png?' + sign, text: '' },
  'emoji6b': { key: 'emoji6b', src: domin + '/emoji6/b.png?' + sign, text: '' },
  'emoji6c': { key: 'emoji6c', src: domin + '/emoji6/c.png?' + sign, text: '' },
  'emoji6d': { key: 'emoji6d', src: domin + '/emoji6/d.png?' + sign, text: '' },
  'emoji6e': { key: 'emoji6e', src: domin + '/emoji6/e.png?' + sign, text: '' },
  'emoji6f': { key: 'emoji6f', src: domin + '/emoji6/f.png?' + sign, text: '' },
  'emoji6g': { key: 'emoji6g', src: domin + '/emoji6/g.png?' + sign, text: '' },
  'emoji6h': { key: 'emoji6h', src: domin + '/emoji6/h.png?' + sign, text: '' },
  'emoji6i': { key: 'emoji6i', src: domin + '/emoji6/i.png?' + sign, text: '' },
};
...
export const getEmojiMap = (emojiIdx, type = 'obj' as 'obj' | 'arr') => {
  ...
  if(emojiIdx === 'emoji2') {
    return type === 'arr' ? Object.values(emoji2Config) : emoji2Config
  }

  if(emojiIdx === 'emoji3') {
    return type === 'arr' ? Object.values(emoji3Config) : emoji3Config
  }

  if(emojiIdx === 'emoji4') {
    return type === 'arr' ? Object.values(emoji4Config) : emoji4Config
  }
  ...
  if(emojiIdx === 'emoji6'){
    return type === 'arr' ? Object.values(emoji6Config) : emoji6Config
  }
}
